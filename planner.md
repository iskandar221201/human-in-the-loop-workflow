...
Does an existing function, helper, or component already do this?
...
Can this be solved by config or data change — not code?
...
Will this function/service method be called from more than one place — now or in the near future?
...
Will this UI component share structure, behavior, or styling with components elsewhere in the codebase?
...
What is the realistic reuse horizon?
...
If built as reusable — is the interface clean enough that another developer could use it without reading the internals?
...
Does the logic this feature needs already exist as inline code in 2 or more places?
...
Is the duplication close enough to generalize cleanly?

If the existing inline implementations are slightly different — identify the common core and spec the abstraction around that core.
Document the differences as parameters or overrides in the abstraction interface.
...
What is the blast radius of extracting now vs later?
...
Read the full-stack overview skill first (e.g. orca-full.md, ams-skill.md) — understand the overall architecture
Read the layer-specific skill for the layer you're touching (e.g. orca-controllers.md, orca-services.md, orca-models.md)
